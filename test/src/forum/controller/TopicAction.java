...
public class TopicAction {
	...
	public String topicToPdf(Model model,HttpServletRequest request,Long topicId){
		if(topicId != null){
			Map<String,Object> map = javaToPdfService.htmlToMap(topicId);
			javaToPdfService.mapToPdf(map);
...
//			}
		...
		return ValidatePcMobile.checkRequest(request, "/forum/topicToPdf");
	}
