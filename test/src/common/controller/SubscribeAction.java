...
//				List<BlogVo> blogList2 = subscribeService.parseXml(new URL("http://www.cnblogs.com/acm-bingzi/article/rss"));
				List<Blog> blogList2 = blogService.updateBlogList(new URL("http://www.cnblogs.com/acm-bingzi/article/rss"));
				model.addAttribute("blogList",blogList2);
			}
		}
