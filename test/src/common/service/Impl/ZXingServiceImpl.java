...
//        String filePath = "E://mylogo.png";  
     ...
     * @param logoPic
     */
    private String addLogo_QRCode(BufferedImage bim, File logoPic, String ansPath)
    {
        try
        {
            /**
             ...
             */
            int widthLogo = logo.getWidth(null)>image.getWidth()*3/11?(image.getWidth()*3/11):logo.getWidth(null), 
                heightLogo = logo.getHeight(null)>image.getHeight()*3/11?(image.getHeight()*3/11):logo.getWidth(null);
